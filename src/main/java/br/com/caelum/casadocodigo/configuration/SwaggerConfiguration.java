package br.com.caelum.casadocodigo.configuration;
...
public class SwaggerConfiguration {
    ...
    public Docket api() { 
        return new Docket(DocumentationType.SWAGGER_2)
        		.select()
        		.apis(RequestHandlerSelectors.basePackage("br.com.caelum.casadocodigo"))
...
//		        .ignoredParameterTypes(User.class)
	...
	private ApiInfo apiInfo() {
		...
		return new ApiInfoBuilder()
				.title("Caelum Casa do Codigo Api - API Documentation")
				.description("Esta é a documentação interativa da Rest API da Casa do Código Api da Caelum. Tente enviar algum request ;)")
				.version("1.0")
				.contact(contato)
				.build();		
	}
